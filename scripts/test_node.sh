...
# CHAIN_ID="localchain_9000-2" HOME_DIR="~/.kudora" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
from_scratch () {
  ...
  # kudo140fehngcrxvhdt84x729p3f0qmkmea8ndgke0s
  ...
  # kudo1r6yue0vuyj9m7xw78npspt9drq2tmtvgp4scum
