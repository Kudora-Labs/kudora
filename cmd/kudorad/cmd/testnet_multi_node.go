...
Example:
	kudorad multi-node --v 4 --output-dir ./.testnets --validators-stake-amount 100000000000000000000,200000000000000000000,300000000000000000000,400000000000000000000 --list-ports 47222,50434,52851,44210
	`,
	...
	cmd.Flags().String(flagValidatorsStakeAmount, "100000000000000000000,100000000000000000000,100000000000000000000,100000000000000000000", "Amount of stake for each validator")
...
func addTestnetFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().String(server.FlagMinGasPrices, fmt.Sprintf("0.0001%s", sdk.DefaultBondDenom), "Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.0001akud)")
...
func initTestnetFiles(
	...
	for i := 0; i < args.numValidators; i++ {
		...
		coins := sdk.Coins{
			sdk.NewCoin(sdk.DefaultBondDenom, accTokens.Add(accStakingTokens)),
		}
